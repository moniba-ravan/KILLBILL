...
public class stationeryActivity extends AppCompatActivity {
    EditText etbook,etstationery;
    String str_book,str_stationery;
    Button btnsumbitsta;
    String addStationery_url = "http://104.236.83.237:7677/addStationery";
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("کتاب و لوازم التحریر");
        etbook=(EditText) findViewById(R.id.book);
        etstationery=(EditText) findViewById(R.id.stationery);
        btnsumbitsta=(Button)findViewById(R.id.submitsta);
        ...
        login();
        btnsumbitsta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int connection = popupForCheckInternet();
                if (connection == 1) {
                    Log.d("after login", "before string request");
                    StringRequest postRequest = new StringRequest(Request.Method.POST, addStationery_url,
                        ...
                        protected Map<String, String> getParams() {
                            ...
                            str_book=etbook.getText().toString();
                            str_stationery= etstationery.getText().toString();
                            if(str_book==null)
                                str_book="0";
                            if(str_stationery==null)
                                str_stationery="0";

                            params.put("books", str_book);
                            params.put("stationery",str_stationery);
    ...
    public int popupForCheckInternet() {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) stationeryActivity.this.getSystemService(stationeryActivity.this.CONNECTIVITY_SERVICE);
        ...
        if ((wifiInfo != null && wifiInfo.isConnected()) || (mobileInfo != null && mobileInfo.isConnected())){
            ...
            Toast.makeText(stationeryActivity.this, "خطای اتصال به اینترنت",
