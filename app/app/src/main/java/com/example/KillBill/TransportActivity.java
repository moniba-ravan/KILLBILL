...
public class TransportActivity extends AppCompatActivity {
    EditText etgeneral,etpersonal;
    String str_general,str_personal;
    Button btnsubmittran;
    String addTransportation_url = "http://104.236.83.237:7677/addTranportation";
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle("حمل و نقل روزانه");
        etgeneral=(EditText) findViewById(R.id.general);
        etpersonal=(EditText) findViewById(R.id.personal);
        btnsubmittran=(Button)findViewById(R.id.submittra);
        ...
        login();
        btnsubmittran.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                int connection = popupForCheckInternet();
                if (connection == 1) {
                    Log.d("after login", "before string request");
                    StringRequest postRequest = new StringRequest(Request.Method.POST, addTransportation_url,
                        ...
                        protected Map<String, String> getParams() {
                            ...
                            str_general=etgeneral.getText().toString();
                            str_personal=etpersonal.getText().toString();
                            if(str_general==null)
                                str_general="0";
                            if(str_personal==null)
                                str_personal="0";

                            params.put("general", str_general);
                            params.put("personal", str_personal);
    ...
    public int popupForCheckInternet() {
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) TransportActivity.this.getSystemService(TransportActivity.this.CONNECTIVITY_SERVICE);
        ...
        if ((wifiInfo != null && wifiInfo.isConnected()) || (mobileInfo != null && mobileInfo.isConnected())){
            ...
            Toast.makeText(TransportActivity.this, "خطای اتصال به اینترنت",
